...
public class OrmTest {
    ...
    private Dao<LineaProducto, Integer> ticketProductoDao;
    ...
    private void clearDataBase() throws SQLException {
        ...
        TableUtils.clearTable(helper.getConnectionSource(), LineaProducto.class);
    }
    ...
    public void ProductoTest() throws Exception {
        ...
        Producto p1 = new Producto("Naranja",c1);
        Producto p2 = new Producto("Judias",c2);
    ...
    public void TiketTest() throws Exception {
        ...
        for (Producto p : productos)
            ticketProductoDao.create(new LineaProducto(t1,p,1, 4, 0.98));

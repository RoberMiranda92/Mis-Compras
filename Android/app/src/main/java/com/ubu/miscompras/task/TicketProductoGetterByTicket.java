 ...
 */
public class TicketProductoGetterByTicket extends AsyncTask<Void, Void, List<LineaProducto>> {
    ...
    public TicketProductoGetterByTicket(OnLoadComplete presenter, Ticket ticket) {

 ...
 */
public class ProductGetterByPriceInteractor extends AsyncTask<Void, Void, List<LineaProducto>> {
            ...
            GenericRawResults<Object[]> rawResults =
                    lineaProductoDao.queryRaw(
                            "SELECT SUM(" + LineaProducto.TABLE_NAME + "." + LineaProducto.CANTIDAD + ")AS Cantidad," +
                                    ...
                                    " WHERE " + LineaProducto.TABLE_NAME + "." + LineaProducto.PRECIO +
                                    ...
                                    " ORDER BY " + LineaProducto.PRECIO + "," + Producto.TABLE_NAME + "." + Producto.NOMBRE_FIELD_NAME,

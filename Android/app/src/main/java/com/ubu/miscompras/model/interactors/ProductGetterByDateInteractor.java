 ...
 */
public class ProductGetterByDateInteractor extends AsyncTask<Void, Void, List<LineaProducto>> {
    ...
    public ProductGetterByDateInteractor(OnLoadComplete presenter, Date startDate, Date endDate) {
